...
def is_mel(name, email):
    ...
    >>> is_mel('mel melitopolski', 'mel@whatever.com')
    True

    >>> is_mel('Mel Melitopolski', None)
    True


    """

    return name == "Mel Melitpolski" or name == "Mel" or name == "mel" or\
    name == "mel melitpolski" or email == "mel@ubermelon.com"\
    or email == "mel@whatever.com" or email == None or name == None
